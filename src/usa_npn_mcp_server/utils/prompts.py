...
PROMPTS: dict[str, PromptEntry] = {
    "map_data": {
        ...
        2. Ask the user for additional parameters (eg species_ids, site_ids, states) they'd like to focus on in order to query the NPN API using the Site Phenometrics tool.
        3. Summarize the data returned from the query, highlighting any obvious key insights.
