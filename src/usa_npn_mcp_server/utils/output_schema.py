...
ANCILLARY_FILES: dict[str, list[str]] = {
    "ancillary_species_data.csv": [
        "species_id",
        "common_name",
        "genus",
        "genus_id",
    ...
    "ancillary_species_protocol_data.csv": [
        "dataset_id",
        "species_id",
        "protocol_id",
        "start_date",
